...
type CalculatorServiceClient interface {
	...
	SumDeadline(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error)
...
func (c *calculatorServiceClient) SumDeadline(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculatorService/SumDeadline", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServiceServer interface {
	...
	SumDeadline(context.Context, *SumRequest) (*SumResponse, error)
...
func (UnimplementedCalculatorServiceServer) SumDeadline(context.Context, *SumRequest) (*SumResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SumDeadline not implemented")
}
...
func _CalculatorService_SumDeadline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServiceServer).SumDeadline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculatorService/SumDeadline",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).SumDeadline(ctx, req.(*SumRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CalculatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SumDeadline",
			Handler:    _CalculatorService_SumDeadline_Handler,
		},
		{
			MethodName: "Sqrt",
